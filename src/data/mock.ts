...
export function getPredefinedField(): Ship[] {
  const randomIndex = Math.floor(Math.random() * predefinedFields.length);
  return predefinedFields[randomIndex];
}
